 ...
 */
public class MyListProductFragmentRecyclerViewAdapter extends RecyclerView.Adapter<MyListProductFragmentRecyclerViewAdapter.ViewHolder> {

    private final List<PlaceholderItem> mValues;

    public MyListProductFragmentRecyclerViewAdapter(List<PlaceholderItem> items) {
        mValues = items;
    }
